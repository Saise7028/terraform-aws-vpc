...
This module is going to create following resources.for HA we are going to get first 2 AZ.
...
* Routes
* Route table associations with sunets
* Peering with default VPC(if Requried)
* Peering routes in acceptor and requestor rote tabble. 

# Inputs
* project_name(Mandatory):user must supply their project name.
* environment(Mandatory):user must supply their envinornment name.
